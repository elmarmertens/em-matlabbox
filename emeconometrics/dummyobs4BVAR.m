function [Ystar, Xstar] = bayesRegDummyObs(Ny, p, Nx, ndxExo, priorMean, dof0, SIGMA0)
...
% FILENAME  : bayesRegDummyObs.m 

%% process arguments
if nargin < 4 || isempty(ndxExo)
    ndxExo = Nx;
end

if nargin < 5 || isempty(priorMean)
    priorMean = 0;
end

if nargin < 6 || isempty(dof0)
    dof0 = 0;
end

if nargin < 7 || isempty(SIGMA0)
    SIGMA0 = eye(Ny);
end
